...
import CreateGrievanceModal from "./CreateGrievanceModal";
import {
  filterGrievances,
  sortGrievances,
  highlightText,
...
const GrievanceList = () => {
  ...
  useEffect(() => {
    const loadGrievances = async () => {
      const grievancesData = await fetchGrievances(navigate);
      setGrievances(grievancesData || []);
    };
    loadGrievances();
  }, [navigate]);

  const handleCreateGrievance = async (title_grievance) => {
    const newGrievance = await createGrievance(title_grievance, navigate);
  ...
  return (
    <div className="layout-content-commune">
      <div className="grid-column">
        <h1 className="title-page-commune">Liste des Doléances</h1>
      </div>
